"""
Based on implementation by luuuyi:
...
class SqueezeNext(nn.Module):
    def __init__(self, num_classes, img_channels, width_x, blocks):
        ...
        self.linear = nn.Linear(int(width_x * 128), self.num_classes)
    ...
    def forward(self, input):
        ...
        output = F.relu(output)
        output = self.maxpool(output)  # added to original implemenation based on paper
