"""
Based on implementation by PingoLH:
https://github.com/PingoLH/Pytorch-HarDNet/blob/master/hardnet.py

HardNet paper: <https://arxiv.org/abs/1909.00948>
"""
...
class Flatten(nn.Module):
    ...
    def forward(self, input):
        output = input.view(input.data.size(0),-1)
        return output
...
class ConvLayer(nn.Sequential):
    def __init__(self, in_channels, out_channels, kernel=3, stride=1, dropout=0.1, bias=False):
        ...
        self.add_module(
            'conv', nn.Conv2d(
                in_channels, out_ch, kernel_size=kernel,
...
class HarDBlock(nn.Module):
    ...
    def __init__(
        self, in_channels, growth_rate, grmul, n_layers,
